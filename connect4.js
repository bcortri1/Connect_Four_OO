...
class Game {
  constructor(P1, P2, HEIGHT = 6, WIDTH = 7){
    ...
    // Game needs to run these function whenever a new Game is made
    this.makeBoard(); 
...
/** handleClick: handle click of column top to play piece */
  handleClick(evt) {
    ...
    // check for win
    if (this.checkForWin()) {
      return this.endGame(`${this.currPlayer.color} player has won!`);
    }
...
//An array of players in game class seems like itd do the same thing
class Player {
  constructor(color){
    this.color = color;
  }
